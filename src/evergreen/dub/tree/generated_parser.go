...
func PrimaryExpr(frame *runtime.State) (ret0 ASTExpr) {
	...
	var r129 rune
	var r130 bool
	var r131 *ConstructList
	var r132 *StringMatch
	var r133 *RuneMatch
	var r134 rune
	var r135 rune
	var r136 bool
																							...
																							if frame.Flow == 0 {
																								...
																								if frame.Flow == 0 {
																									...
																									if frame.Flow == 0 {
																										...
																										if r102 {
																											frame.Consume()
																											r103 = &GetName{Name: r95}
																											r104 = &Append{List: r103, Expr: r99}
																											r105 = &Assign{Expr: r104, Name: r95}
																											ret0 = r105
																											goto block9
																										} else {
																											frame.Fail()
						...
						if frame.Flow == 0 {
							...
							if frame.Flow == 0 {
								...
								if frame.Flow == 0 {
									...
									if r121 {
										frame.Consume()
										r122 = &Construct{Type: r114, Args: r118}
										ret0 = r122
										goto block9
									} else {
										frame.Fail()
						...
						if frame.Flow == 0 {
							...
							if frame.Flow == 0 {
								...
								if frame.Flow == 0 {
									...
									if r130 {
										frame.Consume()
										r131 = &ConstructList{Type: r123, Args: r127}
										ret0 = r131
										goto block9
									} else {
										frame.Fail()
...
block7:
	frame.Recover(r0)
	r132 = StringMatchExpr(frame)
	if frame.Flow == 0 {
		ret0 = r132
		goto block9
	} else {
		frame.Recover(r0)
		r133 = RuneMatchExpr(frame)
		if frame.Flow == 0 {
			ret0 = r133
			goto block9
		} else {
...
block7:
	...
	if frame.Flow == 0 {
		...
		if frame.Flow == 0 {
			EOS(frame)
			if frame.Flow == 0 {
				r70 = &Assign{Expr: r69, Name: r55, Define: r65}
				ret0 = r70
				goto block9
			} else {
				goto block8
